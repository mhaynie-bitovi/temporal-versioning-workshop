...
async def test_replay_valet_v1():
    ...
    #   temporal workflow show --workflow-id <id> --output json > history/valet-CA-1ABC123-history.json
    with open("history/valet-CA-1ABC123-history.json", "r") as f:
        history_json = f.read()
    ...
    await replayer.replay_workflow(
        WorkflowHistory.from_json("valet-CA-1ABC123-history", history_json)
    )
